...
##effect
execute at @p[tag=!sans,distance=..50] run summon item_display ~ ~ ~ {Tags:["bone_sting"],item:{id:bone,components:{custom_model_data:1002}},transformation:[2,0,0,0,0,2,0,1,0,0,2,0,0,0,0,1]}
