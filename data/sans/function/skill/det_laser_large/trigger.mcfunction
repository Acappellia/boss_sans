...
##consume
item replace entity @s weapon.mainhand with bone[custom_model_data=10001,custom_data={sans_skill:1b,sans_det_laser_large_cd:1b},item_name='[{"text": "决心·巨大龙骨炮【冷却中】"}]'] 1
