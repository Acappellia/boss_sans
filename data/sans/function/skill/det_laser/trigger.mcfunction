...
execute if score #laser_basic_counts sans matches 1 run item replace entity @s weapon.mainhand with bone[custom_model_data=10000,custom_data={sans_skill:1b,sans_det_laser_cd:1b},item_name='[{"text": "决心·龙骨炮【冷却中】"}]'] 1
